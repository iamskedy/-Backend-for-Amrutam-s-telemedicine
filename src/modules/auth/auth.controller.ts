...
export const mfaVerifyEnrollmentController = asyncHandler(async (req: Request, res: Response) => {
  const userId = req.user!.sub;
  const { code } = req.body;
...
export const mfaVerifyLoginController = asyncHandler(async (req: Request, res: Response) => {
